...
def test_compared_with_simple(json1, json2, yaml1, yaml2):
    json_simple_view = {('=', 'host'): "hexlet.io", ('-', 'timeout'): 50, ('+', 'timeout'): 20, ('-', 'proxy'): "123.234.53.22", ('-', 'follow'): False, ('+', 'verbose'): True}
    yaml_simple_view = {('=', 'host'): 'hexlet.io', ('-', 'timeout'): 50, ('+', 'timeout'): 20, ('-', 'proxy'): '123.234.53.22', ('-', 'follow'): False, ('+', 'verbose'): True}
...
# def test_format_stylish_complex(jsoncomplex1, jsoncomplex2, yamlcomplex1, yamlcomplex2):
    # assert format_stylish(compared(decoded(jsoncomplex1), decoded(jsoncomplex2))) == open('tests/fixtures/stylish.txt')

#  plain formatter
def test_format_plain_simple(json1, json2, yaml1, yaml2):
    assert format_plain(compared(decoded(json1), decoded(json2)))== 'Property \'follow\' was removed\nProperty \'proxy\' was removed\nProperty \'timeout\' was updated. From 50 to 20\nProperty \'verbose\' was added with value: true'

def test_format_plain_complex(jsoncomplex1, jsoncomplex2, yamlcomplex1, yamlcomplex2):
    pass
